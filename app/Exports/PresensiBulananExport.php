...
class PresensiBulananExport implements FromArray, WithHeadings, WithTitle, ShouldAutoSize, WithEvents
{
    protected $month;
    protected $year;
    ...
    public function array(): array
    {
        ...
        {
            $query->whereMonth('presensi.tanggal_masuk', $this->month);
            $query->whereYear('presensi.tanggal_masuk', $this->year);
        }
